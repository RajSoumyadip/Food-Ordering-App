...
public class Signup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtPassword = (MaterialEditText)findViewById(R.id.edtPassWordSignUp);
        edtPhone = (MaterialEditText)findViewById(R.id.edtPhoneSignUp);
                ...
                tabel_user.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        else
                        {
                            ...
                            Intent i = new Intent(Signup.this,MenuSelectionActivity.class);
                            startActivity(i);
                            finish();
                        }
                    }
